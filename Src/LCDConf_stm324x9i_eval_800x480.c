...
static void LCD_LL_Init(void) 
{
  ...
  /* Set LCD Timings */
  hltdc.Init.HorizontalSync = 0;//40;
  hltdc.Init.VerticalSync = 0;//9;
  hltdc.Init.AccumulatedHBP = 46;//42;
  hltdc.Init.AccumulatedVBP = 23;//11;  
  hltdc.Init.AccumulatedActiveH = 503;//283;
  hltdc.Init.AccumulatedActiveW = 846;//522;
  hltdc.Init.TotalHeigh = 525;//285;
  hltdc.Init.TotalWidth = 1056;//524;
  ...
  /* PLLLCDCLK = PLLSAI_VCO Output/PLLSAIR = 368/4 = 92 Mhz */
  /* LTDC clock frequency = PLLLCDCLK / LTDC_PLLSAI_DIVR_4 = 92/4 = 23 Mhz */
